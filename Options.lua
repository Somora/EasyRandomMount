...
function ERM:RefreshOptions()
    ...
    if self.generalPanel then
        ...
        self.generalPanel.fallingSpellsCheck:SetChecked(db.fallingSpellsEnabled)
...
mainPanel.fallingSpellsCheck = CreateFrame("CheckButton", nil, mainPanel, "InterfaceOptionsCheckButtonTemplate")
mainPanel.fallingSpellsCheck:SetPoint("TOPLEFT", mainPanel.fallingCheck, "BOTTOMLEFT", 0, -8)
mainPanel.fallingSpellsCheck.Text:SetText("Try falling rescue spells (may be blocked by WoW)")
mainPanel.fallingSpellsCheck:SetScript("OnClick", function(self)
    ERM:GetDB().fallingSpellsEnabled = self:GetChecked()
end)

mainPanel.flyingCheck = CreateFrame("CheckButton", nil, mainPanel, "InterfaceOptionsCheckButtonTemplate")
mainPanel.flyingCheck:SetPoint("TOPLEFT", mainPanel.fallingSpellsCheck, "BOTTOMLEFT", 0, -8)
